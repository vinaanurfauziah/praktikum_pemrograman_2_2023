// Latihan 2 Modul ke-2 Komponen Swing 2
// digunakan untuk mewakili satu pilihan input (Silver, Gold, dan Platinum).
...
public class HelloRadioButton extends JFrame {
    ...
    public HelloRadioButton() {
        ...
        labelInput.setBounds(15,40,250,10);
        ...
        //ButtonGroup untuk memastikan hanya ada satu JRadioButton yang dipilih dari semua JRadioButton yang tergabung dalam ButtonGroup.
